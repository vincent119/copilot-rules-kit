---
description: Pulumi YAML 開發規範：resources、options、providers、stacks、config 與 secrets 管理

applyTo: 'Pulumi.yaml,Pulumi.*.yaml,**/*.pulumi.yaml,**/*.pulumi.yml,stacks/**/*.yaml,stack_share_variables/*.yaml'
---
